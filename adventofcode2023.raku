...
sub MAIN(	
	...
	given $day {
		...
		when 19 { day19(@file_lines) }
		when 20 { day20(@file_lines) }
		when 21 { day21(@file_lines) }
		when 22 { day22(@file_lines) }
		when 23 { day23(@file_lines) }
		when 24 { day24(@file_lines) }
		when 25 { day25(@file_lines) }
